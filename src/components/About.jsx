...
export default function About() {
  return (
    <section
      id="about"
      className="flex w-full h-screen items-center py-20 md:py-20k bg-cream"
    >
      <div className="container mx-auto px-6 md:px-12 max-w-4xl text-center">
        ...
        <div className="font-body text-light text-xl md:text-2xl leading-relaxed space-y-6">
          <p>
            Mahasiswa BSI — Sistem Informasi.
          </p>
          ...
          <ScrollRevealText text="Masih belajar, masih ngoding, dan masih sering berantem sama bug. code, one bug at a time. 💀" />
        </div>
      </div>
    </section>
  );
